...
extern bool aesd_circular_buffer_get_offset(struct aesd_circular_buffer *buffer, size_t entry_idx, size_t last_offset,
                                            size_t *out_total_offs);

extern size_t aesd_circular_buffer_get_total_size(struct aesd_circular_buffer *buffer);
