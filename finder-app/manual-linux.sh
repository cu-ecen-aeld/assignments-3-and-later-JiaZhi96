...
cp ${TOOLCHAIN_ROOTFS}/lib64/libm.so.6 ${TOOLCHAIN_ROOTFS}/lib64/libresolv.so.2 ${TOOLCHAIN_ROOTFS}/lib64/libc.so.6 ./lib64/
cp ${TOOLCHAIN_ROOTFS}/lib/ld-linux-aarch64.so.1 ./lib/
